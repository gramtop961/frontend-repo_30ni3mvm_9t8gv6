  ...
  return (
    <Layout>
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Jetzt Agent direkt kaufen</h1>
        <p className="mt-2 text-gray-700">Wählen Sie einen oder mehrere Agents. Zahlung erfolgt nach Onboarding-Formular.</p>
        ...
        <div className="mt-6 p-4 bg-white border rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xl font-extrabold">€{totals.monthly}</div>
          </div>
          <div className="flex items-center justify-between mt-1">
            <div className="text-gray-700">Setup einmalig</div>
            <div className="text-xl font-extrabold">€{totals.setup}</div>
          </div>
