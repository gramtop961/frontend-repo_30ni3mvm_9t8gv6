    ...
    <Layout>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Vereinbaren Sie einen kostenlosen Demo-Termin</h1>
            ...
            <div className="mt-6">
              ...
              <div className="text-xs text-gray-500 mt-2">Alternativ: Schreiben Sie uns über das Formular.</div>
            </div>
          </div>
